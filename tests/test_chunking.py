...
class TestMergeChunkedResults:
            ...
            "segments": [
                {
                    ...
                    "end": 5,
                    "text": "overlap",
                },  # offset=28 -> 28-33, overlaps with 25-30
    ...
    def test_empty_segments(self):
        r1 = {"text": "", "segments": []}
        r2 = {"text": "hello", "segments": [{"start": 0, "end": 5, "text": "hello"}]}
        merged = merge_chunked_results([(r1, 0.0), (r2, 100.0)])
        assert len(merged["segments"]) == 1

    def test_merged_text(self):
        r1 = {"text": "hello", "segments": [{"start": 0, "end": 5, "text": " hello "}]}
        r2 = {"text": "world", "segments": [{"start": 0, "end": 5, "text": " world "}]}
        merged = merge_chunked_results([(r1, 0.0), (r2, 100.0)])
...
@pytest.mark.skipif(
    ...
    reason="pydub not installed or ffmpeg not available",
)
